Shader "Custom/ConvertedCullingOff"
{
	Properties
	{
					...
					// Shared Graph Node Functions
						...
						// Pixel Graph Evaluation
							SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
							{
								...
								float3 _NormalFromTexture_46C3DE9D_Out;
								Unity_NormalFromTexture_float(Texture2D_2C8B3EAF, samplerTexture2D_2C8B3EAF, IN.uv0.xy, 0.5, 8, _NormalFromTexture_46C3DE9D_Out);

								float4 _SampleTexture2D_DCD952C4_RGBA = SAMPLE_TEXTURE2D(Texture2D_E4969401, samplerTexture2D_E4969401, IN.uv0.xy);
								float _SampleTexture2D_DCD952C4_R = _SampleTexture2D_DCD952C4_RGBA.r;
								float _SampleTexture2D_DCD952C4_G = _SampleTexture2D_DCD952C4_RGBA.g;
								float _SampleTexture2D_DCD952C4_B = _SampleTexture2D_DCD952C4_RGBA.b;
								float _SampleTexture2D_DCD952C4_A = _SampleTexture2D_DCD952C4_RGBA.a;
								surface.Albedo = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
								surface.Normal = _NormalFromTexture_46C3DE9D_Out;
								surface.Specular = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
								surface.Emission = (_SampleTexture2D_DCD952C4_RGBA.xyz);
